...
args.add_argument('--mode', default='testgnn', type=str)
...
args.add_argument('--max_grad_norm', default=config[
    
    'train']['max_grad_norm'], type=int)
...
#calibration
args.add_argument('--correct_epochs', default=100, type=int)
args.add_argument('--correctionmode', default='gnn', type=str)
args.add_argument('--alpha', default=0.05,type=int)
args.add_argument('--size_loss_weight', default=1, type=float)
