...
# # Create a directory to store process IDs for tracking
# mkdir -p .tmp_pids

# # Clear any previous output files
# > .tmp_pids/training_pids.txt

# # First, start all training processes in parallel
# echo "Starting all training processes in parallel..."
# for DATASET in "PEMS03_top_12" "PEMS03_w12"
# do
#   if [ $DATASET == "syn_tailup_gen" ]; then
#     syn_seeds=( 30 73 )
#   else
...
# # Now run testing for each model
# echo "Starting testing processes..."
# for DATASET in "PEMS03_top_12" "PEMS03_w12"
# do
#   if [ $DATASET == "syn_tailup_gen" ]; then
...
#   for MODEL in 'AGCRN' 'ASTGCN' "MSTGCN"
#   do
